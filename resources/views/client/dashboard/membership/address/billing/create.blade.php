...
<div class="section">
    ...
    <form action="{{route('client.member.address.billing.store')}}" method="POST">
        @csrf
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" name="phone" id="phone" placeholder="Ex. 01982411111" />
        </div>
        <div class="form-group">
            <label for="email">Email Address *</label>
            <input type="email" class="form-control" name="email" id="email" placeholder="Ex. john.doe@email.com" />
        </div>
        <div class="form-group">
